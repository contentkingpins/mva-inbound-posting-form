// Script to load mock lead data directly on the live site
(function() {
    // The mock data is embedded directly in this script
    const mockLeads = [
        {
    ...
    // Store the mock leads in localStorage
    localStorage.setItem('leads', JSON.stringify(mockLeads));
    localStorage.setItem('mockDataLoaded', 'true');
    
    console.log('Mock data loaded successfully! Refreshing page...');
    
    // Refresh the page to display the mock data
